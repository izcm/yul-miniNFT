...
object "MiniNFT" {
  ...
  object "runtime" {
    ...
    // ON-CHAIN SVG
    data "SVG_HEAD_OLD" "<?xml version='1.0' encoding='UTF-8'?><svg xmlns='http://www.w3.org/2000/svg' width='1600' height='1600' viewBox='0 0 1200 1200'><defs><linearGradient id='A' gradientUnits='userSpaceOnUse'><stop offset='0%' stop-color='#ff5f9c'/><stop offset='100%' stop-color='#d94f8b'/></linearGradient><linearGradient id='B' gradientUnits='userSpaceOnUse'><stop offset='0%' stop-color='#37ee7b'/><stop offset='100%' stop-color='#169c52'/></linearGradient><linearGradient id='C' gradientUnits='userSpaceOnUse'><stop offset='0%' stop-color='#ff9a3c'/><stop offset='100%' stop-color='#cc7722'/></linearGradient><path id='D' d='m712.5 581.25c0 10.355-8.3945 18.75-18.75 18.75s-18.75-8.3945-18.75-18.75 8.3945-18.75 18.75-18.75 18.75 8.3945 18.75 18.75z'/></defs><g fill='none' stroke='url(#"

    data "SVG_HEAD" "<?xml version='1.0' encoding='UTF-8'?><svg xmlns='http://www.w3.org/2000/svg' width='1600' height='1600' viewBox='0 0 1200 1200'><defs><linearGradient id='D'><stop stop-color='#808080'/></linearGradient><linearGradient id='A'><stop stop-color='#ff5f9c'/></linearGradient><linearGradient id='B'><stop stop-color='#37ee7b'/></linearGradient><linearGradient id='C'><stop stop-color='#ff9a3c'/></linearGradient><path id='P' d='m712.5 581.25c0 10.355-8.3945 18.75-18.75 18.75s-18.75-8.3945-18.75-18.75 8.3945-18.75 18.75-18.75 18.75 8.3945 18.75 18.75z'/></defs><g fill='none' stroke='url(#"
